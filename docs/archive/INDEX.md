...
- [Milestone 1 exit evidence](MILESTONE-1-EXIT-EVIDENCE.md) — installed DSP
  discovery-plan comparison, no-execution evidence, and recovery result.
- [Mock completed roadmap](MOCK-ROADMAP.md) — placeholder example of an
  archived completed roadmap.
